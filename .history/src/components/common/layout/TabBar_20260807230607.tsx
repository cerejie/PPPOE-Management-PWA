 ...
 * than `position: fixed` — see AuthenticatedShell. One `pb-tabbar-dock` owns
 * the whole bottom offset (see --tabbar-dock); it must not be combined with a
 * separate safe-area padding, or the two add up and float the bar too high.
 */
export function TabBar() {
  return (
    <nav className="z-30 flex shrink-0 justify-center" aria-label="Main navigation">
      <div className="w-full max-w-app px-12 pb-tabbar-dock">
