 ...
 * than `position: fixed` — see MainLayout. The dock padding owns the whole
 * bottom offset; it must not be combined with a separate safe-area padding, or
 * the two add up and float the bar too high.
 */
        ...
        <div className={styles.pill}>
          {tabs.map((tab) => (
            <NavLink
              ...
              className={({ isActive }) => (isActive ? styles.tab.active : styles.tab.inactive)}
            >
              {tab.icon}
