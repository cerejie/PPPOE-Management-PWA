...
import { useDashboardStats } from '@/hooks/clients/useDashboardStats';
...
export function DashboardScreen() {
  ...
  return (
    <>
        ...
        {stats === undefined ? (
          ...
          <>
            ...
            <div className="mb-2 mt-7 flex items-center justify-between">
              ...
              <Link
                to="/clients"
                className="text-sm font-semibold text-accent-text active:opacity-60"
              >
                See all
              </Link>
            </div>
      ...
      <Fab onClick={() => setShowPayment(true)} label="Record payment" />

      {showPayment && <RecordPaymentSheet onClose={() => setShowPayment(false)} />}
    </>
  );
}
